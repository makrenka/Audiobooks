...
import WithRouter from './components/pages/detail-page/detail-page';
...
export const App = () => (
  <HashRouter>
    <Routes>
      ...
      <Route path='/categories' element={<CategoriesPage heading='Categories' />} />
      ...
      <Route path='/detail/:id' element={<WithRouter />} />
    </Routes>
